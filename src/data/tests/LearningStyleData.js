export const LearningStyleData = {
  id: "kr-learning-style-2026",
  isReady: true,
  title: "우리 아이의 반짝이는 지성, 어떤 빛깔로 피어날까요?",
  subTitle: "배움이 놀이가 되는 순간, 아이의 잠재력을 깨워줄 '인생 학습 메이트'를 찾아보세요.",
  relatedPostUrl: "https://lifechoicepicks.com/early-childhood-edutech-learning-solution-2026/",
  mainImg: "images/krLearningmain.jpg", // 책을 보며 눈을 반짝이는 아이의 사진
  questions: [
    {
      q: "아이가 새로운 책을 만났을 때, 가장 먼저 하는 행동은 무엇인가요?",
      img: "/images/krLearnQ1.jpg",
      a: [
        { text: "책 속의 그림을 가만히 응시하며 나만의 상상에 빠진다.", type: "A" },
        { text: "손으로 책장을 넘기며 그림 사이사이를 꼼꼼히 만져본다.", type: "B" },
        { text: "소리가 나는 도구가 있다면 직접 찍어보며 귀를 기울인다.", type: "C" },
        { text: "엄마, 아빠에게 읽어달라고 가져오며 질문을 쏟아낸다.", type: "D" }
      ]
    },
    {
      q: "장난감을 가지고 놀 때, 아이가 가장 선호하는 방식은?",
      img: "/images/krLearnQ2.jpg",
      a: [
        { text: "색깔별, 크기별로 나만의 기준을 세워 분류하고 정리하기", type: "B" },
        { text: "장난감 캐릭터들과 대화하며 긴 이야기를 만들어내기", type: "C" },
        { text: "화면에 나오는 동작을 따라 하거나 노래를 부르며 활동하기", type: "D" },
        { text: "설명서나 예시 그림을 보며 똑같이 만들어보기", type: "A" }
      ]
    },
    {
      q: "아이가 무언가 새로운 것을 배웠을 때, 가장 뿌듯해하는 순간은?",
      img: "/images/krLearnQ3.jpg",
      a: [
        { text: "직접 손으로 무언가를 완성해냈을 때 (성취감)", type: "B" },
        { text: "새로운 단어나 문장을 말해서 칭찬받았을 때 (표현력)", type: "C" },
        { text: "태블릿이나 기기 속 캐릭터가 보상을 주었을 때 (흥미도)", type: "D" },
        { text: "원리를 이해하고 '아하!' 하며 고개를 끄덕일 때 (이해력)", type: "A" }
      ]
    },
    {
      q: "공부 루틴을 만들고 싶은 당신, 아이에게 제안하고 싶은 첫 시작은?",
      img: "/images/krLearnQ4.jpg",
      a: [
        { text: "조용한 환경에서 집중하며 원리를 익히는 사고력 시간", type: "A" },
        { text: "직접 교구를 만지고 조립하며 수의 개념을 익히는 시간", type: "B" },
        { text: "이야기를 듣고 따라 하며 어휘력을 키우는 독서 시간", type: "C" },
        { text: "AI 선생님과 함께 재미있는 퀴즈를 푸는 스마트 학습 시간", type: "D" }
      ]
    },
    {
      q: "아이를 위한 교육 아이템을 고를 때, 부모님인 당신이 가장 중요하게 생각하는 가치는?",
      img: "/images/krLearnQ5.jpg",
      a: [
        { text: "아이의 사고력을 깊게 만들어줄 검증된 커리큘럼", type: "A" },
        { text: "실제로 손으로 만지며 익힐 수 있는 구체적인 교구 세트", type: "B" },
        { text: "언어 감각을 깨워줄 풍부한 음원과 다채로운 텍스트", type: "C" },
        { text: "아이가 지루해하지 않고 매일 찾게 만드는 재미 요소", type: "D" }
      ]
    }
  ],
  results: {
